        ...
        <div id="cm-menu-items-wrapper">
            <div id="cm-menu-scroller">
                <ul class="cm-menu-items">
                    <li><a id="menu-lista-enquete" href="{{route('enquete.show')}}" class="sf-file-text">Lista das Enquetes</a></li>
                    <li><a id="menu-nova-enquete" href="{{route('enquete.form')}}" class="sf-sign-add">Nova Enquete</a></li>
